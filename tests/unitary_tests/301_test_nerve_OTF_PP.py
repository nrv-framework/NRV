...
def create_nerve(_id):
    ...
    nerve = nrv.nerve(Length=10000, return_parameters_only=False)
    nerve.set_ID(id)
...
def test_default_OFT_PP():
    ...
    res = ner.simulate(save_path='./unitary_tests/figures/')
