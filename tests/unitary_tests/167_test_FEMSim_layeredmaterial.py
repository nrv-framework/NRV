...
mesh.reshape_nerve(res=Nerve_D/10)
mesh.reshape_fascicle(d=Fasc_D, y_c=0, z_c=0, ID=0, res=Fasc_D/20)
...
sig_end = nrv.load_f_material("endoneurium_ranck").sigma
...
print(aplha_lay)
mat_ap.set_anisotropic_conductivity(*get_sig_ap(sig_end, sig_per, Fasc_D/2, per_th))
print(mat_ap.sigma)
