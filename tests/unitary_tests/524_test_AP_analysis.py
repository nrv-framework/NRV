...
for x_AP,t_AP in zip(x_APs,t_APs):
    ...
    plt.scatter(x_max,t_xmax,s=10,c = 'g')
...
plt.savefig('./unitary_tests/figures/524_A.png')
...
plt.ylabel(r'position along the axon($\mu m$)')
plt.xlim(0,results['tstop'])
plt.savefig('./unitary_tests/figures/524_B.png')
...
plt.ylabel(r'position along the axon($\mu m$)')
plt.xlim(0,results['tstop'])
plt.savefig('./unitary_tests/figures/524_C.png')
...
plt.ylabel(r'position along the axon($\mu m$)')
plt.xlim(0,results['tstop'])
plt.savefig('./unitary_tests/figures/524_D.png')
...
plt.ylabel(r'position along the axon($\mu m$)')
plt.xlim(0,results['tstop'])
plt.savefig('./unitary_tests/figures/524_F.png')
...
plt.ylabel(r'position along the axon($\mu m$)')
plt.xlim(0,results['tstop'])
plt.savefig('./unitary_tests/figures/524_G.png')
...
plt.ylabel(r'position along the axon($\mu m$)')
plt.xlim(0,results['tstop'])
plt.savefig('./unitary_tests/figures/524_H.png')
...
plt.ylabel(r'position along the axon($\mu m$)')
plt.xlim(0,results['tstop'])
plt.savefig('./unitary_tests/figures/524_I.png')
