...
ax2.plot(results['t'], results['g_na'][L//2]*1000, label='$g_{Na}$')
ax2.plot(results['t'], results['g_k'][L//2]*1000, label='$g_{K}$')
ax2.plot(results['t'], results['g_l'][L//2]*1000, label='$g_{l}$')
ax2.plot(results['t'], results['g_mem'][L//2]*1000, label='$g_{mem}$')
