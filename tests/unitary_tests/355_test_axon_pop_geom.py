...
def test_axon_pop_set_geometry():
    ...
    assert pop_1.geom.r1 == r1, "Semi-major axis should be set correctly."
    assert pop_1.geom.r2 == r2, "Semi-minor axis should be set correctly."
...
def test_axon_pop_create_geometry():
    ...
    pop_1.set_geometry(center=center, r1=r1, r2=r2, rot=angle)
