...
fen_elec_1.save_electrode(save=True, fname="./unitary_tests/results/json/151_elec1fen.json")
com_elec_1.save_electrode(save=True, fname="./unitary_tests/results/json/151_elec1com.json")
