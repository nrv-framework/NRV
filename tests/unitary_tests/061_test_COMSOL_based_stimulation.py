...
z_c_1 = 50
x_1_offset = 1000
elec_1 = nrv.LIFE_electrode('LIFE_2', D_1, length_1, x_1_offset, y_c_1, z_c_1)
# stimulus def
start = 1
I_cathod = 500
I_anod = I_cathod/5
...
z_c_2 = -50
x_2_offset = 5000
elec_2 = nrv.LIFE_electrode('LIFE_1', D_2, length_2, x_2_offset, y_c_2, z_c_2)
# stimulus def
stim2 = nrv.stimulus()
...
plt.savefig('./unitary_tests/figures/61_A.png')
#plt.show()
