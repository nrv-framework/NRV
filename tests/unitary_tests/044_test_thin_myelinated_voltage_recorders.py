...
axon1 = nrv.thin_myelinated(y,z,d,L,dt=0.001,rec='all')
...
plt.savefig('./unitary_tests/figures/44_A.png')

# test 2
axon2 = nrv.thin_myelinated(y,z,d,L,dt=0.001,rec='nodes')
...
plt.yticks([])
plt.xlabel('time ($ms$)')
plt.savefig('./unitary_tests/figures/44_B.png')
