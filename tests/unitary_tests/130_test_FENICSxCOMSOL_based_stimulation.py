...
fen_elec_1.save_electrode(save=True, fname="./unitary_tests/results/json/130_elec1fen.json")
fen_elec_1.save_electrode(save=True, fname="./unitary_tests/results/json/130_elec1com.json")
