...
my_model = 'Nerve_1_Fascicle_2_LIFE'
...
z_c_2 = -50
x_2_offset = 7000
elec_2 = nrv.LIFE_electrode('LIFE_2', D_2, length_2, x_2_offset, y_c_2, z_c_2)
# stimulus def
start_2 = 6
I_cathod_2 = 40
I_anod_2 = I_cathod/5
...
# simulate the axon
results = axon1.simulate(t_sim=10, footprints=footprints)
del axon1
...
plt.savefig('./unitary_tests/figures/72_A.png')
...
plt.xlim(0.9,7)
plt.xlabel('time ($ms$)')
plt.savefig('./unitary_tests/figures/72_B.png')