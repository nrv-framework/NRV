...
#creating the fascicles are populating them
    ...
    fascicle_2_c.set_geometry(diameter=fasc2_d, rot=90, degree=True)

    n_ax = 100      #size of the axon population
    fascicle_1_c.fill(n_ax=n_ax, percent_unmyel=0.7, M_stat="Ochoa_M", U_stat="Ochoa_U", delta=2, delta_trace=10)

    fascicle_2_c.fill(n_ax=n_ax, percent_unmyel=0.7, M_stat="Ochoa_M", U_stat="Ochoa_U", delta=2)
