...
if __name__ == "__main__":
    if nrv.COMSOL_Status:
        ...
        fascicle_1.set_ID(73)
        # extra cellular stimulation
        fascicle_1.attach_extracellular_stimulation(test_stim)

        #Footprint saving
        footprints = fascicle_1.compute_electrodes_footprints(save_ftp_only=True, filename="./unitary_tests/figures/073_electrodes_footprints_on_axon.ftpts")
