...
def blocking_threshold(diameter,L,material,dist_elec,block_freq,position_elec=0.5,model='MRG',amp_max=2000,amp_min=0,amp_tol=15,Nseg_per_sec=None,verbose=True,f_dlambda = 100,dt=0.005):
    amplitude_max_th=amp_max
    amplitude_min_th=amp_min
    amplitude_tol=amp_tol
    # axon
