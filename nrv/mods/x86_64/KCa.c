...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "alpha_kca", _hoc_alpha,
 "beta_kca", _hoc_beta,
 "rates_kca", _hoc_rates,
 0, 0
};
#define alpha alpha_kca
#define beta beta_kca
#define rates rates_kca
...
#define A_betac A_betac_kca
 double A_betac = 0.05;
#define A_alphac A_alphac_kca
 double A_alphac = 750;
#define B_betac B_betac_kca
 double B_betac = -10;
#define B_alphac B_alphac_kca
 double B_alphac = -10;
#define C_betac C_betac_kca
 double C_betac = -60;
#define C_alphac C_alphac_kca
 double C_alphac = 12;
#define Q10TempB Q10TempB_kca
 double Q10TempB = 10;
#define Q10TempA Q10TempA_kca
 double Q10TempA = 22.85;
#define Q10kcac Q10kcac_kca
 double Q10kcac = 2.3;
 ...
 "Q10kcac_kca", &Q10kcac_kca,
 "Q10TempA_kca", &Q10TempA_kca,
 "Q10TempB_kca", &Q10TempB_kca,
 "A_alphac_kca", &A_alphac_kca,
 "B_alphac_kca", &B_alphac_kca,
 "C_alphac_kca", &C_alphac_kca,
 "A_betac_kca", &A_betac_kca,
 "B_betac_kca", &B_betac_kca,
 "C_betac_kca", &C_betac_kca,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kca /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/KCa.mod\n");
...
/*CVODE*/
 ...
 static int states (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) { {
   rates ( _threadargscomma_ v ) ;
    c = c + (1. - exp(dt*(( ( ( - 1.0 ) ) ) / tau_c)))*(- ( ( ( cinf ) ) / tau_c ) / ( ( ( ( - 1.0 ) ) ) / tau_c ) - c) ;
   }
  return 0;
}
...
double alpha ( _threadargsprotocomma_ double _lVm ) {
   double _lalpha;
 alphac = A_alphac * cai * exp ( ( _lVm + B_alphac ) / C_alphac ) ;
...
double beta ( _threadargsprotocomma_ double _lVm ) {
   double _lbeta;
 betac = A_betac * exp ( ( _lVm + B_betac ) / C_betac ) ;
...
double rates ( _threadargsprotocomma_ double _lVm ) {
 ...
 alpha ( _threadargscomma_ _lVm ) ;
   ...
   tau_c = tau_c * pow( Q10kcac , ( ( Q10TempA - celsius ) / Q10TempB ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/KCa.mod";
static const char* nmodl_file_text = 
