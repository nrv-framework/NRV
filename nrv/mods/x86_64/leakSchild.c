...
#define nrn_init _nrn_init__leakSchild
#define _nrn_initial _nrn_initial__leakSchild
#define nrn_cur _nrn_cur__leakSchild
#define _nrn_current _nrn_current__leakSchild
#define nrn_jacob _nrn_jacob__leakSchild
#define nrn_state _nrn_state__leakSchild
#define _net_receive _net_receive__leakSchild 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_leakSchild", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define R R_leakSchild
 double R = 8.314;
#define ecaoffset ecaoffset_leakSchild
 double ecaoffset = 78.7;
#define z z_leakSchild
 double z = 2;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gbca_leakSchild", 0, 1e+09,
 "gbna_leakSchild", 0, 1e+09,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "R_leakSchild", "joule/degC",
 "ecaoffset_leakSchild", "mV",
 "gbna_leakSchild", "S/cm2",
 "gbca_leakSchild", "S/cm2",
 "ica_leakSchild", "mA/cm2",
 "ina_leakSchild", "mA/cm2",
 0,0
};
 /* connect global user variables to hoc */
 static DoubScal hoc_scdoub[] = {
 "R_leakSchild", &R_leakSchild,
 "z_leakSchild", &z_leakSchild,
 "ecaoffset_leakSchild", &ecaoffset_leakSchild,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "ca_ion");
 	...
 	ivoc_help("help ?1 leakSchild /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/leakSchild.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ecaleak = ( 1000.0 ) * ( R * ( celsius + 273.15 ) / z / FARADAY * log ( cao / cai ) ) - ecaoffset ;
   ina = gbna * ( v - ena ) ;
   ica = gbca * ( v - ecaleak ) ;
   }
 _current += ina;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/leakSchild.mod";
static const char* nmodl_file_text = 
