...
#define nrn_init _nrn_init__stin_sensory
#define _nrn_initial _nrn_initial__stin_sensory
#define nrn_cur _nrn_cur__stin_sensory
#define _nrn_current _nrn_current__stin_sensory
#define nrn_jacob _nrn_jacob__stin_sensory
#define nrn_state _nrn_state__stin_sensory
#define _net_receive _net_receive__stin_sensory 
#define evaluate_fct evaluate_fct__stin_sensory 
#define states states__stin_sensory 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_stin_sensory", _hoc_setdata,
 "Exp_stin_sensory", _hoc_Exp,
 "evaluate_fct_stin_sensory", _hoc_evaluate_fct,
 "vtrapNB_stin_sensory", _hoc_vtrapNB,
 "vtrapNA_stin_sensory", _hoc_vtrapNA,
 0, 0
};
#define Exp Exp_stin_sensory
#define vtrapNB vtrapNB_stin_sensory
#define vtrapNA vtrapNA_stin_sensory
...
#define anC anC_stin_sensory
 double anC = 1.1;
#define anB anB_stin_sensory
 double anB = -83.2;
#define anA anA_stin_sensory
 double anA = 0.0462;
#define aqC aqC_stin_sensory
 double aqC = -12.2;
#define aqB aqB_stin_sensory
 double aqB = -94.2;
#define aqA aqA_stin_sensory
 double aqA = 0.00522;
#define asC asC_stin_sensory
 double asC = -5;
#define asB asB_stin_sensory
 double asB = -27;
#define asA asA_stin_sensory
 double asA = 0.3;
#define bnC bnC_stin_sensory
 double bnC = 10.5;
#define bnB bnB_stin_sensory
 double bnB = -66;
#define bnA bnA_stin_sensory
 double bnA = 0.0824;
#define bqC bqC_stin_sensory
 double bqC = -12.2;
#define bqB bqB_stin_sensory
 double bqB = -94.2;
#define bqA bqA_stin_sensory
 double bqA = 0.00522;
#define bsC bsC_stin_sensory
 double bsC = -1;
#define bsB bsB_stin_sensory
 double bsB = 10;
#define bsA bsA_stin_sensory
 double bsA = 0.03;
#define vtraub vtraub_stin_sensory
 double vtraub = -80;
 ...
 "gkbar_stin_sensory", "mho/cm2",
 "gl_stin_sensory", "mho/cm2",
 "gq_stin_sensory", "mho/cm2",
 "gkf_stin_sensory", "mho/cm2",
 "ek_stin_sensory", "mV",
 "el_stin_sensory", "mV",
 "eq_stin_sensory", "mV",
 "ekf_stin_sensory", "mV",
 "ik_stin_sensory", "mA/cm2",
 "il_stin_sensory", "mA/cm2",
 "iq_stin_sensory", "mA/cm2",
 "ikf_stin_sensory", "mA/cm2",
 0,0
};
 ...
 "vtraub_stin_sensory", &vtraub_stin_sensory,
 "asA_stin_sensory", &asA_stin_sensory,
 "asB_stin_sensory", &asB_stin_sensory,
 "asC_stin_sensory", &asC_stin_sensory,
 "bsA_stin_sensory", &bsA_stin_sensory,
 "bsB_stin_sensory", &bsB_stin_sensory,
 "bsC_stin_sensory", &bsC_stin_sensory,
 "aqA_stin_sensory", &aqA_stin_sensory,
 "aqB_stin_sensory", &aqB_stin_sensory,
 "aqC_stin_sensory", &aqC_stin_sensory,
 "bqA_stin_sensory", &bqA_stin_sensory,
 "bqB_stin_sensory", &bqB_stin_sensory,
 "bqC_stin_sensory", &bqC_stin_sensory,
 "anA_stin_sensory", &anA_stin_sensory,
 "anB_stin_sensory", &anB_stin_sensory,
 "anC_stin_sensory", &anC_stin_sensory,
 "bnA_stin_sensory", &bnA_stin_sensory,
 "bnB_stin_sensory", &bnB_stin_sensory,
 "bnC_stin_sensory", &bnC_stin_sensory,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 stin_sensory /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/stin_sensory.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Sensory Axon Stin channels";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/stin_sensory.mod";
static const char* nmodl_file_text = 
