...
#define nrn_init _nrn_init__stin_motor
#define _nrn_initial _nrn_initial__stin_motor
#define nrn_cur _nrn_cur__stin_motor
#define _nrn_current _nrn_current__stin_motor
#define nrn_jacob _nrn_jacob__stin_motor
#define nrn_state _nrn_state__stin_motor
#define _net_receive _net_receive__stin_motor 
#define evaluate_fct evaluate_fct__stin_motor 
#define states states__stin_motor 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_stin_motor", _hoc_setdata,
 "Exp_stin_motor", _hoc_Exp,
 "evaluate_fct_stin_motor", _hoc_evaluate_fct,
 "vtrapNB_stin_motor", _hoc_vtrapNB,
 "vtrapNA_stin_motor", _hoc_vtrapNA,
 0, 0
};
#define Exp Exp_stin_motor
#define vtrapNB vtrapNB_stin_motor
#define vtrapNA vtrapNA_stin_motor
...
#define anC anC_stin_motor
 double anC = 1.1;
#define anB anB_stin_motor
 double anB = -83.2;
#define anA anA_stin_motor
 double anA = 0.0462;
#define aqC aqC_stin_motor
 double aqC = -12.2;
#define aqB aqB_stin_motor
 double aqB = -107.3;
#define aqA aqA_stin_motor
 double aqA = 0.00522;
#define asC asC_stin_motor
 double asC = -5;
#define asB asB_stin_motor
 double asB = -27;
#define asA asA_stin_motor
 double asA = 0.3;
#define bnC bnC_stin_motor
 double bnC = 10.5;
#define bnB bnB_stin_motor
 double bnB = -66;
#define bnA bnA_stin_motor
 double bnA = 0.0824;
#define bqC bqC_stin_motor
 double bqC = -12.2;
#define bqB bqB_stin_motor
 double bqB = -107.3;
#define bqA bqA_stin_motor
 double bqA = 0.00522;
#define bsC bsC_stin_motor
 double bsC = -1;
#define bsB bsB_stin_motor
 double bsB = 10;
#define bsA bsA_stin_motor
 double bsA = 0.03;
#define vtraub vtraub_stin_motor
 double vtraub = -80;
 ...
 "gkbar_stin_motor", "mho/cm2",
 "gl_stin_motor", "mho/cm2",
 "gq_stin_motor", "mho/cm2",
 "gkf_stin_motor", "mho/cm2",
 "ek_stin_motor", "mV",
 "el_stin_motor", "mV",
 "eq_stin_motor", "mV",
 "ekf_stin_motor", "mV",
 "ik_stin_motor", "mA/cm2",
 "il_stin_motor", "mA/cm2",
 "iq_stin_motor", "mA/cm2",
 "ikf_stin_motor", "mA/cm2",
 "tau_s_stin_motor", "ms",
 "tau_q_stin_motor", "ms",
 "tau_n_stin_motor", "ms",
 0,0
 ...
 "vtraub_stin_motor", &vtraub_stin_motor,
 "asA_stin_motor", &asA_stin_motor,
 "asB_stin_motor", &asB_stin_motor,
 "asC_stin_motor", &asC_stin_motor,
 "bsA_stin_motor", &bsA_stin_motor,
 "bsB_stin_motor", &bsB_stin_motor,
 "bsC_stin_motor", &bsC_stin_motor,
 "aqA_stin_motor", &aqA_stin_motor,
 "aqB_stin_motor", &aqB_stin_motor,
 "aqC_stin_motor", &aqC_stin_motor,
 "bqA_stin_motor", &bqA_stin_motor,
 "bqB_stin_motor", &bqB_stin_motor,
 "bqC_stin_motor", &bqC_stin_motor,
 "anA_stin_motor", &anA_stin_motor,
 "anB_stin_motor", &anB_stin_motor,
 "anC_stin_motor", &anC_stin_motor,
 "bnA_stin_motor", &bnA_stin_motor,
 "bnB_stin_motor", &bnB_stin_motor,
 "bnC_stin_motor", &bnC_stin_motor,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 stin_motor /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/stin_motor.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Motor Axon Stin channels";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/stin_motor.mod";
static const char* nmodl_file_text = 
  "TITLE Motor Axon Stin channels\n"
  "\n"
  ": 06/16\n"
  ": Jessica Gaines\n"
  ":\n"
