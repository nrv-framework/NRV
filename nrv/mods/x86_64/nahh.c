...
#define nrn_init _nrn_init__nahh
#define _nrn_initial _nrn_initial__nahh
#define nrn_cur _nrn_cur__nahh
#define _nrn_current _nrn_current__nahh
#define nrn_jacob _nrn_jacob__nahh
#define nrn_state _nrn_state__nahh
#define _net_receive _net_receive__nahh 
#define mhn mhn__nahh 
#define states states__nahh 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_nahh", _hoc_setdata,
 "alp_nahh", _hoc_alp,
 "bet_nahh", _hoc_bet,
 "expM1_nahh", _hoc_expM1,
 "mhn_nahh", _hoc_mhn,
 0, 0
};
#define alp alp_nahh
#define bet bet_nahh
#define expM1 expM1_nahh
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nahh /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/nahh.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "nahh ";
...
double alp (  double _lv , double _li ) {
 ...
 _lv = _lv + 65.0 ;
   ...
   if ( _li  == 0.0 ) {
     _lv = _lv + mshift ;
     _lalp = _lq10 * .32 * expM1 ( _threadargscomma_ 13.1 - _lv , 4.0 ) ;
     }
   else if ( _li  == 1.0 ) {
     _lv = _lv + hshift ;
     _lalp = _lq10 * .128 * exp ( ( 17.0 - _lv + ishift ) / 18.0 ) ;
     }
...
double bet (  double _lv , double _li ) {
 ...
 _lv = _lv + 65.0 ;
   ...
   if ( _li  == 0.0 ) {
     _lv = _lv + mshift ;
     _lbet = _lq10 * .28 * expM1 ( _threadargscomma_ _lv - 40.1 , 5.0 ) ;
     }
   else if ( _li  == 1.0 ) {
     _lv = _lv + hshift ;
     _lbet = _lq10 * 4.0 / ( exp ( ( 40.0 - _lv ) / 5.0 ) + 1.0 ) ;
     }
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 42 in file nahh.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/nahh.mod";
static const char* nmodl_file_text = 
  "TITLE nahh \n"
