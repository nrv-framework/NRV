...
#define nrn_init _nrn_init__caintscale
#define _nrn_initial _nrn_initial__caintscale
#define nrn_cur _nrn_cur__caintscale
#define _nrn_current _nrn_current__caintscale
#define nrn_jacob _nrn_jacob__caintscale
#define nrn_state _nrn_state__caintscale
#define _net_receive _net_receive__caintscale 
#define state state__caintscale 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_caintscale", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define nb nb_caintscale
 double nb = 4;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "diam");
 	...
 	ivoc_help("help ?1 caintscale /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/caintscale.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   double _ldiffOc ;
 _ldiffOc = ku * cai * ( 1.0 - Oc ) - kr * Oc ;
   DOc = _ldiffOc ;
   Dcai = - ica * ( SA ) / Vol / ( 2.0 * FARADAY ) - ( nb * Bi * _ldiffOc ) ;
   }
 return _reset;
}
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = &(Oc) - _p;  _dlist1[0] = &(DOc) - _p;
 _slist1[1] = &(cai) - _p;  _dlist1[1] = &(Dcai) - _p;
 _slist2[0] = &(Oc) - _p;
 _slist2[1] = &(cai) - _p;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/caintscale.mod";
static const char* nmodl_file_text = 
