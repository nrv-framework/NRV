...
#define nrn_init _nrn_init__flut_sensory
#define _nrn_initial _nrn_initial__flut_sensory
#define nrn_cur _nrn_cur__flut_sensory
#define _nrn_current _nrn_current__flut_sensory
#define nrn_jacob _nrn_jacob__flut_sensory
#define nrn_state _nrn_state__flut_sensory
#define _net_receive _net_receive__flut_sensory 
#define evaluate_fct evaluate_fct__flut_sensory 
#define states states__flut_sensory 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_flut_sensory", _hoc_setdata,
 "Exp_flut_sensory", _hoc_Exp,
 "evaluate_fct_flut_sensory", _hoc_evaluate_fct,
 "vtrapNB_flut_sensory", _hoc_vtrapNB,
 "vtrapNA_flut_sensory", _hoc_vtrapNA,
 0, 0
};
#define Exp Exp_flut_sensory
#define vtrapNB vtrapNB_flut_sensory
#define vtrapNA vtrapNA_flut_sensory
...
#define anC anC_flut_sensory
 double anC = 1.1;
#define anB anB_flut_sensory
 double anB = -83.2;
#define anA anA_flut_sensory
 double anA = 0.0462;
#define aqC aqC_flut_sensory
 double aqC = -12.2;
#define aqB aqB_flut_sensory
 double aqB = -94.2;
#define aqA aqA_flut_sensory
 double aqA = 0.00522;
#define asC asC_flut_sensory
 double asC = -5;
#define asB asB_flut_sensory
 double asB = -27;
#define asA asA_flut_sensory
 double asA = 0.3;
#define bnC bnC_flut_sensory
 double bnC = 10.5;
#define bnB bnB_flut_sensory
 double bnB = -66;
#define bnA bnA_flut_sensory
 double bnA = 0.0824;
#define bqC bqC_flut_sensory
 double bqC = -12.2;
#define bqB bqB_flut_sensory
 double bqB = -94.2;
#define bqA bqA_flut_sensory
 double bqA = 0.00522;
#define bsC bsC_flut_sensory
 double bsC = -1;
#define bsB bsB_flut_sensory
 double bsB = 10;
#define bsA bsA_flut_sensory
 double bsA = 0.03;
#define vtraub vtraub_flut_sensory
 double vtraub = -80;
 ...
 "gkbar_flut_sensory", "mho/cm2",
 "gl_flut_sensory", "mho/cm2",
 "gq_flut_sensory", "mho/cm2",
 "gkf_flut_sensory", "mho/cm2",
 "ek_flut_sensory", "mV",
 "el_flut_sensory", "mV",
 "eq_flut_sensory", "mV",
 "ekf_flut_sensory", "mV",
 "ik_flut_sensory", "mA/cm2",
 "il_flut_sensory", "mA/cm2",
 "iq_flut_sensory", "mA/cm2",
 "ikf_flut_sensory", "mA/cm2",
 0,0
};
 ...
 "vtraub_flut_sensory", &vtraub_flut_sensory,
 "asA_flut_sensory", &asA_flut_sensory,
 "asB_flut_sensory", &asB_flut_sensory,
 "asC_flut_sensory", &asC_flut_sensory,
 "bsA_flut_sensory", &bsA_flut_sensory,
 "bsB_flut_sensory", &bsB_flut_sensory,
 "bsC_flut_sensory", &bsC_flut_sensory,
 "aqA_flut_sensory", &aqA_flut_sensory,
 "aqB_flut_sensory", &aqB_flut_sensory,
 "aqC_flut_sensory", &aqC_flut_sensory,
 "bqA_flut_sensory", &bqA_flut_sensory,
 "bqB_flut_sensory", &bqB_flut_sensory,
 "bqC_flut_sensory", &bqC_flut_sensory,
 "anA_flut_sensory", &anA_flut_sensory,
 "anB_flut_sensory", &anB_flut_sensory,
 "anC_flut_sensory", &anC_flut_sensory,
 "bnA_flut_sensory", &bnA_flut_sensory,
 "bnB_flut_sensory", &bnB_flut_sensory,
 "bnC_flut_sensory", &bnC_flut_sensory,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 flut_sensory /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/flut_sensory.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/flut_sensory.mod";
static const char* nmodl_file_text = 
