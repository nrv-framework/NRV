...
#define nrn_init _nrn_init__extrapump
#define _nrn_initial _nrn_initial__extrapump
#define nrn_cur _nrn_cur__extrapump
#define _nrn_current _nrn_current__extrapump
#define nrn_jacob _nrn_jacob__extrapump
#define nrn_state _nrn_state__extrapump
#define _net_receive _net_receive__extrapump 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_extrapump", _hoc_setdata,
 0, 0
};
 ...
 "pumpik_extrapump", "mA/cm2",
 "pumpina_extrapump", "mA/cm2",
 "pumpica_extrapump", "mA/cm2",
 "ik_extrapump", "mA/cm2",
 "ina_extrapump", "mA/cm2",
 "ica_extrapump", "mA/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "ca_ion");
 	...
 	ivoc_help("help ?1 extrapump /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/extrapump.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/extrapump.mod";
static const char* nmodl_file_text = 
