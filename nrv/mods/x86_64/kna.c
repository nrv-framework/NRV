...
#define nrn_init _nrn_init__kna
#define _nrn_initial _nrn_initial__kna
#define nrn_cur _nrn_cur__kna
#define _nrn_current _nrn_current__kna
#define nrn_jacob _nrn_jacob__kna
#define nrn_state _nrn_state__kna
#define _net_receive _net_receive__kna 
...
#define EC50 EC50_kna
 double EC50 = 38.7;
#define nH nH_kna
 double nH = 3.5;
#define pmax pmax_kna
 double pmax = 0.37;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "k_ion");
 	...
 	ivoc_help("help ?1 kna /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/kna.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/kna.mod";
static const char* nmodl_file_text = 
