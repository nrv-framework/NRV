...
#define nai _p[10]
#define ko _p[11]
#define Dinapump _p[12]
#define Dikpump _p[13]
#define v _p[14]
#define _g _p[15]
#define _ion_nai	*_ppvar[0]._pval
#define _ion_ina	*_ppvar[1]._pval
#define _ion_dinadv	*_ppvar[2]._pval
#define _ion_ko	*_ppvar[3]._pval
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "nain_nakpump", "mM",
 "kout_nakpump", "mM",
 "smalla_nakpump", "mA/cm2",
 "b1_nakpump", "mM",
 "inapump_nakpump", "mA/cm2",
 "ikpump_nakpump", "mA/cm2",
 "ina_nakpump", "mA/cm2",
 "ik_nakpump", "mA/cm2",
 0,0
};
 static double ikpump0 = 0;
 static double inapump0 = 0;
...
static void nrn_alloc(Prop* _prop) {
 ...
 nrn_promote(prop_ion, 1, 0);
 	_ppvar[3]._pval = &prop_ion->param[2]; /* ko */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "k_ion");
 	...
 	ivoc_help("help ?1 nakpump /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/Nakpump.mod\n");
...
static void _modl_cleanup(){ _match_recurse=1;}
 ...
 static void _update_ion_pointer(Datum* _ppvar) {
   ...
   nrn_update_ion_pointer(_k_sym, _ppvar, 3, 2);
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   kvotqt = pow( 1.0 , ( ( celsius - 22.0 ) / 10.0 ) ) ;
   ikpump = smalla / ( pow( ( 1.0 + b1 / ko ) , 2.0 ) ) * ( 1.62 / ( 1.0 + pow( ( 6.7 / ( nai + 8.0 ) ) , 3.0 ) ) + 1.0 / ( 1.0 + pow( ( 67.6 / ( nai + 8.0 ) ) , 3.0 ) ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/Nakpump.mod";
static const char* nmodl_file_text = 
