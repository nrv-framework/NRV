...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 can /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/can.mod\n");
...
double rates ( _threadargsprotocomma_ double _lVm ) {
 ...
 rn = 0.2 / ( 1.0 + exp ( ( _lVm + A_rn + shiftcan ) / B_rn ) ) ;
   ...
   ecan = ( 1000.0 ) * ( R * ( celsius + 273.15 ) / z / FARADAY * log ( cao / cai ) ) - ecaoffset ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/can.mod";
static const char* nmodl_file_text = 
  ...
  "				V0p5d=-20.0 (mV)		:As defined by Schild 1994, zinf=1.0/(1.0+exp((V-V0p5z)/(-S0p5z))\n"
  "				S0p5d=4.5 (mV)\n"
  "			\n"
  "			: Tau Variables\n"
  ...
  "		ecan=(1000)*(R*(celsius+273.15)/z/FARADAY*log(cao/cai))-ecaoffset \n"
  "		\n"
