...
#define nrn_init _nrn_init__nas97mean
#define _nrn_initial _nrn_initial__nas97mean
#define nrn_cur _nrn_cur__nas97mean
#define _nrn_current _nrn_current__nas97mean
#define nrn_jacob _nrn_jacob__nas97mean
#define nrn_state _nrn_state__nas97mean
#define _net_receive _net_receive__nas97mean 
#define states states__nas97mean 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_nas97mean", _hoc_setdata,
 "rates_nas97mean", _hoc_rates,
 0, 0
};
#define rates rates_nas97mean
 extern double rates( _threadargsprotocomma_ double );
 /* declare global and static user variables */
#define A_tauh A_tauh_nas97mean
 double A_tauh = 10.75;
#define A_taum A_taum_nas97mean
 double A_taum = 1.45;
#define B_tauh B_tauh_nas97mean
 double B_tauh = 0.067;
#define B_taum B_taum_nas97mean
 double B_taum = 0.058;
#define C_tauh C_tauh_nas97mean
 double C_tauh = 3.15;
#define C_taum C_taum_nas97mean
 double C_taum = 0.26;
#define Q10TempB Q10TempB_nas97mean
 double Q10TempB = 10;
#define Q10TempA Q10TempA_nas97mean
 double Q10TempA = 22;
#define Q10nash Q10nash_nas97mean
 double Q10nash = 1.5;
#define Q10nasm Q10nasm_nas97mean
 double Q10nasm = 2.3;
#define S0p5h S0p5h_nas97mean
 double S0p5h = -5.2;
#define S0p5m S0p5m_nas97mean
 double S0p5m = 5.54;
#define Vph Vph_nas97mean
 double Vph = -13.5;
#define V0p5h V0p5h_nas97mean
 double V0p5h = -31;
#define Vpm Vpm_nas97mean
 double Vpm = -14.5;
#define V0p5m V0p5m_nas97mean
 double V0p5m = -11.29;
 ...
 "Q10TempA_nas97mean", "degC",
 "Q10TempB_nas97mean", "degC",
 "V0p5m_nas97mean", "mV",
 "S0p5m_nas97mean", "mV",
 "A_taum_nas97mean", "ms",
 "B_taum_nas97mean", "/mV",
 ...
 "C_tauh_nas97mean", "ms",
 "Vph_nas97mean", "mV",
 "gbar_nas97mean", "S/cm2",
 "ina_nas97mean", "mA/cm2",
 0,0
};
 ...
 "Q10nasm_nas97mean", &Q10nasm_nas97mean,
 "Q10nash_nas97mean", &Q10nash_nas97mean,
 "Q10TempA_nas97mean", &Q10TempA_nas97mean,
 "Q10TempB_nas97mean", &Q10TempB_nas97mean,
 "V0p5m_nas97mean", &V0p5m_nas97mean,
 "S0p5m_nas97mean", &S0p5m_nas97mean,
 "A_taum_nas97mean", &A_taum_nas97mean,
 "B_taum_nas97mean", &B_taum_nas97mean,
 "C_taum_nas97mean", &C_taum_nas97mean,
 "Vpm_nas97mean", &Vpm_nas97mean,
 "V0p5h_nas97mean", &V0p5h_nas97mean,
 "S0p5h_nas97mean", &S0p5h_nas97mean,
 "A_tauh_nas97mean", &A_tauh_nas97mean,
 "B_tauh_nas97mean", &B_tauh_nas97mean,
 "C_tauh_nas97mean", &C_tauh_nas97mean,
 "Vph_nas97mean", &Vph_nas97mean,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nas97mean /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/nas97mean.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/nas97mean.mod";
static const char* nmodl_file_text = 
