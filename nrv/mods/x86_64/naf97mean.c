...
#define nrn_init _nrn_init__naf97mean
#define _nrn_initial _nrn_initial__naf97mean
#define nrn_cur _nrn_cur__naf97mean
#define _nrn_current _nrn_current__naf97mean
#define nrn_jacob _nrn_jacob__naf97mean
#define nrn_state _nrn_state__naf97mean
#define _net_receive _net_receive__naf97mean 
#define states states__naf97mean 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_naf97mean", _hoc_setdata,
 "rates_naf97mean", _hoc_rates,
 0, 0
};
#define rates rates_naf97mean
 extern double rates( _threadargsprotocomma_ double );
 /* declare global and static user variables */
#define A_tauh A_tauh_naf97mean
 double A_tauh = 18;
#define A_taum A_taum_naf97mean
 double A_taum = 1.15;
#define B_tauh B_tauh_naf97mean
 double B_tauh = 0.043;
#define B_taum B_taum_naf97mean
 double B_taum = 0.06;
#define C_tauh C_tauh_naf97mean
 double C_tauh = 1.35;
#define C_taum C_taum_naf97mean
 double C_taum = 0.21;
#define Q10TempB Q10TempB_naf97mean
 double Q10TempB = 10;
#define Q10TempA Q10TempA_naf97mean
 double Q10TempA = 22;
#define Q10nafh Q10nafh_naf97mean
 double Q10nafh = 1.5;
#define Q10nafm Q10nafm_naf97mean
 double Q10nafm = 2.3;
#define S0p5h S0p5h_naf97mean
 double S0p5h = -5.97;
#define S0p5m S0p5m_naf97mean
 double S0p5m = 6.98;
#define Vph Vph_naf97mean
 double Vph = -62.5;
#define V0p5h V0p5h_naf97mean
 double V0p5h = -65.99;
#define Vpm Vpm_naf97mean
 double Vpm = -40;
#define V0p5m V0p5m_naf97mean
 double V0p5m = -31.62;
 ...
 "Q10TempA_naf97mean", "degC",
 "Q10TempB_naf97mean", "degC",
 "V0p5m_naf97mean", "mV",
 "S0p5m_naf97mean", "mV",
 "A_taum_naf97mean", "ms",
 "B_taum_naf97mean", "/mV",
 ...
 "C_tauh_naf97mean", "ms",
 "Vph_naf97mean", "mV",
 "gbar_naf97mean", "S/cm2",
 "ina_naf97mean", "mA/cm2",
 0,0
};
 ...
 "Q10nafm_naf97mean", &Q10nafm_naf97mean,
 "Q10nafh_naf97mean", &Q10nafh_naf97mean,
 "Q10TempA_naf97mean", &Q10TempA_naf97mean,
 "Q10TempB_naf97mean", &Q10TempB_naf97mean,
 "V0p5m_naf97mean", &V0p5m_naf97mean,
 "S0p5m_naf97mean", &S0p5m_naf97mean,
 "A_taum_naf97mean", &A_taum_naf97mean,
 "B_taum_naf97mean", &B_taum_naf97mean,
 "C_taum_naf97mean", &C_taum_naf97mean,
 "Vpm_naf97mean", &Vpm_naf97mean,
 "V0p5h_naf97mean", &V0p5h_naf97mean,
 "S0p5h_naf97mean", &S0p5h_naf97mean,
 "A_tauh_naf97mean", &A_tauh_naf97mean,
 "B_tauh_naf97mean", &B_tauh_naf97mean,
 "C_tauh_naf97mean", &C_tauh_naf97mean,
 "Vph_naf97mean", &Vph_naf97mean,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 naf97mean /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/naf97mean.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/naf97mean.mod";
static const char* nmodl_file_text = 
  ...
  "	PARAMETER {\n"
  "		gbar =0.068967142	(S/cm2)	: (S/cm2) Channel Conductance This is the conductance from Schild 1994, not the conductance from Schild 1997\n"
