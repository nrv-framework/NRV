...
#define ICaPmax22 ICaPmax22_CaPump
 double ICaPmax22 = 0.000859437;
#define Q10TempB Q10TempB_CaPump
 double Q10TempB = 10;
#define Q10TempA Q10TempA_CaPump
 double Q10TempA = 22.85;
#define Q10CaP Q10CaP_CaPump
 double Q10CaP = 2.3;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "ICaPmax22_CaPump", 0, 1e+06,
 "KmCa_CaPump", 0, 1e+06,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "ICaPmax22_CaPump", "mA/cm2",
 "Q10TempA_CaPump", "degC",
 "Q10TempB_CaPump", "degC",
 "KmCa_CaPump", "mM",
 "ica_CaPump", "mA/cm2",
 "icap_CaPump", "mA/cm2",
 "ICaPmax_CaPump", "mA/cm2",
 0,0
};
 /* connect global user variables to hoc */
 static DoubScal hoc_scdoub[] = {
 "ICaPmax22_CaPump", &ICaPmax22_CaPump,
 "Q10CaP_CaPump", &Q10CaP_CaPump,
 "Q10TempA_CaPump", &Q10TempA_CaPump,
 "Q10TempB_CaPump", &Q10TempB_CaPump,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "ca_ion");
 	...
 	ivoc_help("help ?1 CaPump /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/CaPump.mod\n");
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
  int _i; double _save;{
 {
   ICaPmax = ICaPmax22 * pow( Q10CaP , ( ( Q10TempA - celsius ) / Q10TempB ) ) ;
   }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/CaPump.mod";
static const char* nmodl_file_text = 
