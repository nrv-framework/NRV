...
#define nrn_init _nrn_init__caextscale
#define _nrn_initial _nrn_initial__caextscale
#define nrn_cur _nrn_cur__caextscale
#define _nrn_current _nrn_current__caextscale
#define nrn_jacob _nrn_jacob__caextscale
#define nrn_state _nrn_state__caextscale
#define _net_receive _net_receive__caextscale 
#define state state__caextscale 
...
#define txfer _p[1]
#define SA _p[2]
#define Vol_peri _p[3]
#define nseg _p[4]
#define L _p[5]
#define lseg _p[6]
#define Volratio _p[7]
#define ica _p[8]
#define Vol _p[9]
#define cao _p[10]
#define Dcao _p[11]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_caextscale", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define Vol_periSchild Vol_periSchild_caextscale
 double Vol_periSchild = 1.46136e-09;
#define VolSchild VolSchild_caextscale
 double VolSchild = 1.41372e-08;
#define cabath cabath_caextscale
 double cabath = 2;
 ...
 "cabath_caextscale", "mM",
 "VolSchild_caextscale", "cm3",
 "Vol_periSchild_caextscale", "cm3",
 "fhspace_caextscale", "um",
 "txfer_caextscale", "ms",
 "SA_caextscale", "cm2",
 "Vol_peri_caextscale", "cm3",
 "nseg_caextscale", "1",
 "L_caextscale", "um",
 "lseg_caextscale", "cm",
 "Volratio_caextscale", "1",
 0,0
};
 ...
 "cabath_caextscale", &cabath_caextscale,
 "VolSchild_caextscale", &VolSchild_caextscale,
 "Vol_periSchild_caextscale", &Vol_periSchild_caextscale,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "diam");
 	...
 	ivoc_help("help ?1 caextscale /Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/caextscale.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   Dcao = ica * SA / ( 2.0 * Vol_peri * FARADAY ) + ( cabath - cao ) / txfer ;
   }
 return _reset;
}
 static int _ode_matsol1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
 Dcao = Dcao  / (1. - dt*( ( ( ( - 1.0 ) ) ) / txfer )) ;
  return 0;
}
 /*END CVODE*/
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/louisregnacq/Dropbox/Work/Model/NRV/NRV/nrv/mods/caextscale.mod";
static const char* nmodl_file_text = 
