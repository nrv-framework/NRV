...
from ..utils._misc import gen_idx_arange, plot_array, adjust_axes, compute_v_rec_cap_idxs
...
def synchronize_times(res1:eit_forward_results, res2:eit_forward_results, dt_min=0.001)->np.ndarray:
    t1 = res1["t"]
    t2 = res2["t"]
