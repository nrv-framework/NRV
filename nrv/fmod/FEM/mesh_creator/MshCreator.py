...
class MshCreator:
    def __init__(self, D):
        ...
        # gmsh.option.set_number('Mesh.MaxNumThreads3D', 4)
    ...
    def add_box(self,x=0, y=0, z=0, ax=5, ay=1, az=1):
        ...
        if self.D ==3:
            ...
            print('Not added : add_cylinder requiere 3D mesh')
            return None
    ...
    def fragment(self, IDs=None, dim=3):
        """
        ...
        if IDs is None:
            ...
            print('Need at least 2 entities to fragment')
            return -1
        else:
        ...
        new_entities={}
        print("Warning: New volume generated by fragmentation, bounds are no longer up to date")
        for i in frag[0][:]:
    ...
    def visualize(self, fname=None):
        if fname is None and self.file == "":
            print("Can't visualize : Mesh not save and no fname")
